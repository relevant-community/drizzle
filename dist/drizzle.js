    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          _context3.next = 11;
          return fallback.currentProvider.on('connect', function (e) {
            return new _DrizzleContract2.default(web3Contract, web3, address || contractArtifact.contractName, store, events, contractArtifact, fallbackContract);
          });
...
function initializeDrizzle(action) {
  var options, web3Options, drizzle, _ref, fallback, web3, i, contractConfig, events, contractName, syncAlways, interval;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = _context.t0 === 'ws' ? 7 : 13;
          break;
