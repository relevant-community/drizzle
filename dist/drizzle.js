    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = _context.t0 === 'ws' ? 6 : _context.t0 === 'https' ? 15 : _context.t0 === 'http' ? 15 : 21;
          break;
        ...
        case 15:
          ...
          provider = new Web3.providers.HttpProvider(options.fallback.url, { headers: [{ name: 'Access-Control-Allow-Origin', value: '*' }, { name: 'Access-Control-Allow-Methods', value: '*' }, { name: 'Access-Control-Allow-Headers', value: '*' }] });
